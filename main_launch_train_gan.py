...
def main():
    ...
    if args.unet_checkpoint_path:
        unet_state_dict = SimpleDenoiser.load_from_checkpoint(args.unet_checkpoint_path).model.state_dict()

    model = DNGAN(
        [64, 128, 256, 512, 512], block=ConvBnReluBlock, variance_min=0.01, variance_max=0.5,
